...
const Example = () => {
  ...
  return (
    <View style={styles.wrapper}>
      ...
      <Text style={styles.action}>
        - create a new text file inside <Text style={styles.textBold}>RNFS2Example2Folder1</Text> called{' '}
        <Text style={styles.textBold}>folder1.txt</Text>
      </Text>

      <Text style={styles.action}>
        - create a new text file inside <Text style={styles.textBold}>RNFS2Example2Folder2</Text> called{' '}
      ...
      <Text style={styles.action}>
        - list all files inside <Text style={styles.textBold}>RNFS2Example2Folder2</Text> folder
      </Text>
